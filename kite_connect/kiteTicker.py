...
class KiteTicker(object):
    ...
    def __init__(self, api_key="", access_token="", debug=False, root=None,
        ...
        self.socket_url = "wss://ws.zerodha.com/?api_key=kitefront&user_id=YOZ898&enctoken=Sgnkx4juF3ZcqGWhkFAvUg68wwvKXSOfVYiMluo7LjR3%2B1iiaZH12kxv4rha2YqQFbTtjQ9z38EyHTcZJzLe6xT%2BSAJLuamfnqoP%2By0Eysx8rj%2BvJqMhzw%3D%3D&uid=1680934788323&user-agent=kite3-web&version=3.0.14"
    ...
    def _user_agent(self):
        # TODO: set __title__ and __version__ (or just buy the damned thing)
